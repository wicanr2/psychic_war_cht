...
| 7 | [R7](R7-baked-text-and-assist-features.md) | 圖檔文字清冊與中文替換、F2 切換語言、F10 即時存檔、F1 說明頁、試玩抽測第二個區域 |
| 8 | [R8](R8-baked-text-rest-and-map.md) | 房間招牌與道具圖鑑的中文、F3 自動地圖、防拷、作弊、抽測 |
